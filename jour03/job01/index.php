...
<div class="d-flex justify-content-around">
  <div class="w-3 p-3" style="Height:34rem">
    <img src="img/1.jpg" class="card-img-top" alt="...">
    <div class="card-body" style="background:White;">
      <h5 class="card-title">Un Papillon</h5>
      <p class="card-text">Un papillon, c'est un peu comme une chenille, mais avec des ailes.
      <br>Ne pas ingerer</p>
      <a href="#" class="btn btn-primary justify-content-center">Commander votre propre papillon</a>
    </div>
  </div>

  <div class="jumbotronn" >
  <h1 class="display-4">Bonjour, monde!</h1>
  <p class="lead">Il existe plusieurs versions du terme: <br><br>le monde est la matière, l'espace le phénomène qui noussont accessibles par les sens, l'expérience ou la raison. <br><br> Le sens le plus courant désigne notre planète, la Terre, avec ses habitants, et son environnement plus ou moins naturel.</p>
  <hr class="my-4">
...
<div class="w-60 p-3">
  <ul>
    ...
    <li class="list-group-item">ColereRuse et Tromperie</li>
